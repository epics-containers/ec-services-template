#{{ grouping_name }} {{ grouping_type }} IOCs and Services

{{ description }}.

This repository holds the a description of {{ grouping_name }} {{ grouping_type }} IOCs and services. Each sub folder of the `services` directory contains a helm chart for a specific service or IOC.
